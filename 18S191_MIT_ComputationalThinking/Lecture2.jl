...
# ╔═╡ 62980296-0cf7-4429-bc67-ddd6024994d5
begin
	using Statistics
	using Images
	using FFTW
...
# ╔═╡ 23f3cc20-faa5-11eb-0186-130904787d98
begin
...
# ╔═╡ 922fe842-38fc-4b95-8c37-2abd27c4b2e9
size(philip)

# ╔═╡ 31345197-e20b-4b4c-b9a2-8613ca80f4a8
kernel = Kernel.gaussian((2,2))

# ╔═╡ 564cdb51-268a-4087-9cd8-82b339c31d18
function show_colored_kernel(kernel)
	to_rgb(x) = RGB(max(-x,0), max(x,0),0)
	to_rgb.(kernel) /maximum(abs.(kernel))
end

# ╔═╡ a40215c7-47c7-4ea2-ba32-0e79d9bfa81f
show_colored_kernel(kernel)

# ╔═╡ 022dc665-aa2c-4af8-9fdd-300cfd09999f
...
# ╔═╡ 7145c835-2804-4153-b4f5-793c13d57829
conv_image = convolve(philip, kernel)
