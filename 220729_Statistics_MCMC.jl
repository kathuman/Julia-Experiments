...
# ╔═╡ 5fbfae5d-b6ca-47d1-888e-21e33e2e2d29
begin
	using AlgebraOfGraphics, CairoMakie
	using AlgebraOfGraphics: density
	df1 = (x=randn(1000), c=rand(["a", "b"], 1000))
	plt1 = data(df1) * mapping(:x, color=:c) * density(bandwidth=0.5)
	fg1 = draw(plt1)
end

# ╔═╡ 58428e32-0f3a-11ed-3950-dd8ed390913e
begin
...
# ╔═╡ c0bffb88-6971-40e5-bc40-1cd4b0d43070
@df DF boxplot(
  :AGE,
  xlab = "Age",
  ylab = "Distribution"    
...
# ╔═╡ 30fa026a-69d5-43b8-bd50-78d2831e3770
"""http://juliaplots.org/AlgebraOfGraphics.jl/dev/gallery/gallery/statistical%20analyses/density_plots/#Density-plots"""

# ╔═╡ d5ce7a71-c76c-4ade-8af8-c5aba201f926
begin
	df2 = (x=randn(1000), c=rand(["a", "b"], 1000))
	plt2 = data(df2) * mapping(:x, color=:c, stack=:c) * AlgebraOfGraphics.histogram(bins=20)
	fg2 = draw(plt2)
end

# ╔═╡ 57ddd37b-c4cc-4bbb-bde6-704ff6e0d7c9
begin
	resolution = (800, 600)
	fig3 = Figure(; resolution)
	ax = Axis(fig3[1, 1], title="Some plot")
	...
	plt3 = data(df3) * mapping(:x, :y, col=:i, row=:j, color=:k, marker=:l)
	...
	legend!(fig3[end+1, 2], ag, orientation=:horizontal, tellheight=true)
	fig3
end
