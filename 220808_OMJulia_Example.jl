...
# ╔═╡ f8906822-16f7-11ed-3452-73f19ae43287
using OMJulia

# ╔═╡ 3a1d483d-ab5a-43eb-b6ee-76d4072c1e18
# https://openmodelica.org/doc/OpenModelicaUsersGuide/latest/omjulia.html

# ╔═╡ b3420bd3-cd97-4301-9a9c-4dd3794b605f
omc= OMJulia.OMCSession()

# ╔═╡ d1a49506-1fc3-4b2c-8636-8014270d5998
sendExpression(omc,"loadModel(Modelica)")

# ╔═╡ 667640c2-6037-4507-833f-f34ae5788052
sendExpression(omc,"model a Real s; equation s=sin(10*time); end a;")

# ╔═╡ 9c720ea4-8835-47e7-a0eb-e2252572303c
sendExpression(omc,"simulate(a)")

# ╔═╡ cc8baa9a-63b1-4205-9696-e482c6608c0a
...
[[OMJulia]]
deps = ["Compat", "DataFrames", "DataStructures", "LightXML", "Random", "ZMQ"]
git-tree-sha1 = "39be02d3f31cee21f0741eb7f6e850ceaa973972"
