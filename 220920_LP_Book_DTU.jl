...
# ╔═╡ 48870d40-38c0-11ed-10be-5f11562866e7
using JuMP, HiGHS

# ╔═╡ db25a5b4-30ad-4aa3-a2be-f0d7bcbb09ea
IC = Model(HiGHS.Optimizer)

# ╔═╡ 2a3cbaea-98a7-4f3b-aa43-9851246b6782
begin
	@variable(IC,xA>=0)
	@variable(IC,xB>=0)	
...
# ╔═╡ 38167638-e8c0-4212-82ba-d98668cb08d8
print(IC)

# ╔═╡ 9a0e5f14-cb3c-4720-9e68-1d1045687124
optimize!(IC)

# ╔═╡ 8ead64d2-c474-4a1e-8d8c-1cd559f9f22c
begin
